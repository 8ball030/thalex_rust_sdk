...
pub struct Rfq {
    ...
    pub quoted_bid: Option<Box<models::RfqQuotedBid>>,
    #[serde(rename = "quoted_ask", skip_serializing_if = "Option::is_none")]
    pub quoted_ask: Option<Box<models::RfqQuotedAsk>>,
...
impl Rfq {
    pub fn new(rfq_id: String, amount: f64, create_time: f64, legs: Vec<models::RfqLegsInner>) -> Rfq {
        Rfq {
            rfq_id,
            amount,
            create_time,
