...
pub struct OrderStatus {
    ...
    #[serde(rename = "conditional_order_id", skip_serializing_if = "Option::is_none")]
...
impl OrderStatus {
    /// Order status.
    pub fn new(order_id: String, order_type: OrderType, time_in_force: TimeInForce, direction: Direction, amount: f64, filled_amount: f64, remaining_amount: f64, status: Status, fills: Vec<models::OrderFill>, change_reason: ChangeReason, insert_reason: InsertReason, create_time: f64, persistent: bool) -> OrderStatus {
        OrderStatus {
            order_id,
            order_type,
            time_in_force,
