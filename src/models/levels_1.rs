...
impl Levels1 {
    pub fn new(bot_id: String, status: Status, strategy: String, instrument_name: String, bids: Vec<f64>, asks: Vec<f64>, step_size: f64, base_position: f64, upside_exit_price: f64, downside_exit_price: f64, end_time: f64) -> Levels1 {
        Levels1 {
            bot_id,
            status,
            stop_reason: None,
