...
pub struct PortfolioEntry {
    ...
    #[serde(rename = "perpetual_funding_entry_value", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "unrealised_perpetual_funding", skip_serializing_if = "Option::is_none")]
