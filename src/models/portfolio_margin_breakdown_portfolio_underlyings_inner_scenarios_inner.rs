...
pub struct PortfolioMarginBreakdownPortfolioUnderlyingsInnerScenariosInner {
    ...
    pub positions: Option<Vec<models::PortfolioMarginBreakdownPortfolioUnderlyingsInnerScenariosInnerPositionsInner>>,
    /// Results of scenario simulations on affected asset positions.
    #[serde(rename = "assets", skip_serializing_if = "Option::is_none")]
    pub assets: Option<Vec<models::PortfolioMarginBreakdownPortfolioUnderlyingsInnerScenariosInnerAssetsInner>>,
