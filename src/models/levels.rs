...
impl Levels {
    pub fn new(strategy: String, instrument_name: String, bids: Vec<f64>, asks: Vec<f64>, step_size: f64, upside_exit_price: f64, downside_exit_price: f64, end_time: f64) -> Levels {
        Levels {
            strategy,
            instrument_name,
            bids,
