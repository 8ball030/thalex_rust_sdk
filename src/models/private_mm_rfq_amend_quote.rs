...
#[serde(untagged)]
pub enum PrivateMmRfqAmendQuote {
    PrivateMmRfqAmendQuoteResult(Box<models::PrivateMmRfqAmendQuoteResult>),
    ErrorResponse(Box<models::ErrorResponse>),
}

impl Default for PrivateMmRfqAmendQuote {
    fn default() -> Self {
        Self::PrivateMmRfqAmendQuoteResult(Default::default())
    }
}
///
