...
impl AccountSummary {
    pub fn new(unrealised_pnl: f64, cash_collateral: f64, margin: f64, required_margin: f64, remaining_margin: f64, session_realised_pnl: f64, cash: Vec<models::AccountSummaryCashInner>) -> AccountSummary {
        AccountSummary {
            unrealised_pnl,
            cash_collateral,
            margin,
