...
impl Sgsl1 {
    pub fn new(bot_id: String, status: Status, strategy: String, instrument_name: String, signal: Signal, entry_price: f64, target_position: f64, exit_price: f64, exit_position: f64, end_time: f64) -> Sgsl1 {
        Sgsl1 {
            bot_id,
            status,
            stop_reason: None,
