...
impl OrderHistory {
    /// Historical order.
    pub fn new(order_id: String, order_type: OrderType, direction: Direction, amount: f64, filled_amount: f64, status: Status, fills: Vec<models::OrderFill>, delete_reason: DeleteReason, insert_reason: InsertReason, create_time: f64, close_time: f64) -> OrderHistory {
        OrderHistory {
            order_id,
            order_type,
