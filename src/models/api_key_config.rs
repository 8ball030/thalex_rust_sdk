...
pub struct ApiKeyConfig {
    ...
    pub notifications: Option<std::collections::HashMap<String, models::NotificationPreferencesApiKeyValue>>,
...
impl ApiKeyConfig {
    /// API key config
    pub fn new(nickname: String, default_account_number: String, permissions: Vec<models::ApiKeyConfigPermissionsInner>, active: bool) -> ApiKeyConfig {
        ApiKeyConfig {
            nickname,
