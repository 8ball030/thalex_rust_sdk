...
pub struct Success14ResultTransactionsInner {
...
impl Success14ResultTransactionsInner {
    pub fn new(time: f64, asset: String, amount: f64, description: String) -> Success14ResultTransactionsInner {
