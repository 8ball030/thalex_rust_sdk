...
impl ConditionalOrder {
    pub fn new(order_id: String, instrument_name: String, direction: Direction, amount: f64, target: Target, stop_price: f64, status: Status, create_time: f64, update_time: f64, reject_reason: String, reduce_only: bool) -> ConditionalOrder {
        ConditionalOrder {
            order_id,
            instrument_name,
            direction,
