...
impl Ocq1 {
    pub fn new(bot_id: String, status: Status, strategy: String, instrument_name: String, signal: Signal, bid_offset: f64, ask_offset: f64, quote_size: f64, min_position: f64, max_position: f64, end_time: f64) -> Ocq1 {
        Ocq1 {
            bot_id,
            status,
            stop_reason: None,
