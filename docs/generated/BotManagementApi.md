...
[**rest_private_slash_cancel_all_bots**](BotManagementApi.md#rest_private_slash_cancel_all_bots) | **POST** /private/cancel_all_bots | Cancel all bots
[**rest_private_slash_cancel_bot**](BotManagementApi.md#rest_private_slash_cancel_bot) | **POST** /private/cancel_bot | Cancel a bot
...
## rest_private_slash_cancel_all_bots

> models::ErrorResponse rest_private_slash_cancel_all_bots(body)
Cancel all bots

Exchange: `https://thalex.com/api/v2/private/cancel_all_bots`  Testnet: `https://testnet.thalex.com/api/v2/private/cancel_all_bots`  Cancel all bots of this subaccount 
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**rest_private_cancel_bot_request** | Option<[**RestPrivateCancelBotRequest**](RestPrivateCancelBotRequest.md)> |  |  |
