...
**status** | **String** | One of [\"active\", \"stopped\"]. | 
...
**grid** | **Vec<f64>** | The default price levels the bot will be quoting at. See [the bot strategies section](#tag/bot_strategies) for more explanation. | 
**step_size** | **f64** | The default size to quote on one level. See [the bot strategies section](#tag/bot_strategies) for more explanation. | 
